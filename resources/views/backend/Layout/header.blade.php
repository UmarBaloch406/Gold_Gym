                  ...
                  <div class="card-body px-0">
                    ...
                    <div class="dlab-scroll px-3 mt-3 height300">
                      <ul class="d-flex align-items-center mb-3">
                        <li>
                          <img src="{{ asset('backend/images/avatar/1.jpg') }}" class="avatar avatar-sm" alt="">
                      ...
                      <ul class="d-flex align-items-center mb-3">
                        <li>
                          <img src="{{ asset('backend/images/avatar/2.jpg') }}" class="avatar avatar-sm" alt="">
                      ...
                      <ul class="d-flex align-items-center mb-3">
                        <li>
                          <img src="{{ asset('backend/images/avatar/4.jpg') }}" class="avatar avatar-sm" alt="">
                          <a href="javascript:void(0);" class="ms-2">Benjamin</a>
                      ...
                      <ul class="d-flex align-items-center mb-3">
                        <li>
                          <img src="{{ asset('backend/images/avatar/3.jpg') }}" class="avatar avatar-sm" alt="">
                          <a href="javascript:void(0);" class="ms-2">Benjamin</a>
                  ...
                  <div class="card mb-0">
                    <div class="card-header p-3">
                      <ul class="d-flex align-items-center">
                        <li>
                          <img src="{{ asset('backend/images/user.jpg') }}" class="ms-0" alt="">
                        </li>
                        <li class="ms-2">
    ...
    <div class="dlabnav-scroll">	
      <ul class="metismenu" id="menu">
        ...
        <ul aria-expanded="false">
          ...
          <li><a href="{{route('trainer.select')}}">Trainer Detail</a></li>
          <li><a href="{{route('trainer')}}">Add New Trainer</a></li>
        ...
        <div class="card bg-transparent mb-1">
          ...
          <div class="card-body height450 dlab-scroll loadmore-content recent-activity-wrapper p-3 pt-2" id="RecentActivityContent">
            ...
            <div class="d-flex align-items-center student">
              <span class="dz-media">
                <img src="{{ asset('backend/images/profile/small/pic1.jpg') }}" alt="" width="50" class="avatar">
              </span>
              <div class="user-info">
            ...
            <div class="d-flex align-items-center student">
              <span class="dz-media">
                <img src="{{ asset('backend/images/profile/small/pic2.jpg') }}" alt="" width="50" class="avatar">
              </span>
              <div class="user-info">
            ...
            <div class="d-flex align-items-center student">
              <span class="dz-media">
                <img src="{{ asset('backend/images/profile/small/pic3.jpg') }}" alt="" class="avatar">
              </span>
              <div class="user-info">
            ...
            <div class="d-flex align-items-center student">
              <span class="dz-media">
                <img src="{{ asset('backend/images/profile/small/pic4.jpg') }}" alt="" class="avatar">
              </span>
              <div class="user-info">
            ...
            <div class="d-flex align-items-center student">
              <span class="dz-media">
                <img src="{{ asset('backend/images/profile/small/pic5.jpg') }}" alt="" class="avatar">
              </span>
              <div class="user-info">
          ...
          <div class="card-body height450 dlab-scroll p-0 px-3" id="messageContent">
            ...
            <div class="d-flex student border-bottom">
              <div class="d-flex align-items-center">
                <span class="dz-media">
                  <img src="{{ asset('backend/images/profile/small/pic1.jpg') }}" alt="" class="avatar">
                </span>
                <div class="user-info">
                  <h6 class="name"><a href="app-profile.html">Samantha William</a></h6>
            ...
            <div class="d-flex student border-bottom">
              <div class="d-flex align-items-center">
                <span class="dz-media">
                  <img src="{{ asset('backend/images/profile/small/pic2.jpg') }}" alt="" class="avatar">
                </span>
                <div class="user-info">
                  <h6 class="name"><a href="app-profile.html">Tony Soap</a></h6>
                  <span class="fs-14 font-w400 text-wrap">Lorem ipsum dolor sit</span>
        ...
        <div class="card tags bg-transparent mb-0">
          ...
          <div class="card-body  p-3 py-1 ">	
            <div class="card-body-inner food">
              <span class="dz-media">
                <img src="{{ asset('backend/images/food/pic1.jpg') }}" alt="" class="avatar">
              </span>
              <div class="user-info">
            ...
            <div class="card-body-inner food">
              <span class="dz-media">
                <img src="{{ asset('backend/images/food/pic2.jpg') }}" alt="" class="avatar">
              </span>
              <div class="user-info">
            ...
            <div class="card-body-inner food">
              <span class="dz-media">
                <img src="{{ asset('backend/images/food/pic3.jpg') }}" alt="" class="avatar">
              </span>
              <div class="user-info">
